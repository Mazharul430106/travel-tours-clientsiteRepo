    ...
    return (
        <div className='px-[7%] py-5 pb-10'>
            ...
            <div className='text-center py-5 pb-10 '>
                ...
                <p className=''>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iure quia hic ducimus quam dolorum ullam omnis quod? <br /> Molestias maxime, distinctio minus consectetur iure est, aliquam sit porro esse neque ducimus.</p>
            </div>
